...
export class RentalComponent implements OnInit {
  ...
  addRental(rental:Rental){
    ...
    if(this.rentable=true){
      ...
      this.toastrService.error("You cannot rent the car for these dates","Already rented")
      console.log("You cannot rent the car for these dates","Already rented")
    }
  }
  ...
  calculatePrice(){
    if(this.startDate && this.endDate){
      ...
      if (result>0){
        ...
        this.rentPrice = 0
        this.toastrService.info("You cannot rent the car for these dates","!")
      }
    }
      ...
      this.rentPrice = 0
      this.toastrService.info("You cannot rent the car for these dates","!")
      console.log("You cannot rent the car for these dates")
    }
  }
