...
export class CreditCardComponent implements OnInit {
  ...
  async rentACar(){
    ...
    if(this.cardExist){
      ...
      this.toastrService.success("You have rented the car","Operation successful")
    }else{
      this.toastrService.error("Your bank did not validate your information","Card not found")
    }
  }
